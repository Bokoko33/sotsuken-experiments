  ...
  <div class="intro">
    ...
    <div class="intro__desc-pc">
      <p class="intro__text">
        ...
        >程です。時間の計測は特に行っていませんので、あまり実験を意識せず普段通り操作してください。
      </p>
    ...
    <br />
    <p class="intro__note">
      *ブラウザの「戻る」ボタンの使用、リロードはしないでください。
    </p>
    <p class="intro__note">*通信環境の良い所でのご協力をお願いします。</p>
    <p class="intro__note">
      *不具合などありましたら、お手数ですが依頼者までご報告いただけますと幸いです。
    </p>
